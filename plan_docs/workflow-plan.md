...
<!-- Note: The 'rename' language in prior descriptions referred to updating the `name` property within `.devcontainer/devcontainer.json`, not renaming the file itself. The workspace file name was verified to match the repository name. -->
